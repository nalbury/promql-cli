...
COBRA := $(GOBIN)/cobra-v1.1.3
$(COBRA): $(BINGO_DIR)/cobra.mod
	@# Install binary/ries using Go 1.14+ build command. This is using bwplotka/bingo-controlled, separate go module with pinned dependencies.
	@echo "(re)installing $(GOBIN)/cobra-v1.1.3"
	@cd $(BINGO_DIR) && $(GO) build -mod=mod -modfile=cobra.mod -o=$(GOBIN)/cobra-v1.1.3 "github.com/spf13/cobra/cobra"
